...
<?$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "PARENT_SECTION_CODE" => "",
        "PREVIEW_TRUNCATE_LEN" => "",
        "PROPERTY_CODE" => array("BASE_PRICE", "INCLUDE", "ADDITIONAL_CLASS", "PRICE_SIGN_DETAIL", "HIDDEN", "FOR_PRESENT", "PRICE", "TITLE"),
        "SET_BROWSER_TITLE" => "N",
        "SET_LAST_MODIFIED" => "N",
        "SET_META_DESCRIPTION" => "N",
        "SET_META_KEYWORDS" => "N",
...
<? if($arResult['PROPERTIES']['MAP_HIDDEN']['VALUE'] != 'Да'):?>
    ...
    <script src="<?=SITE_TEMPLATE_PATH?>/js/map-leafletjs.min.js?version=11?>"></script>
