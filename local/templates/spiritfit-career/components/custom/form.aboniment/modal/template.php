...
$arField = ['name', 'surname', 'phone', 'email'];
?>
<div class="form-standart form-standart_tpl-ver form-standart_white-bg">
        <div class="form-standart__plate">
            ...
            <form class="subscription__aside-form_v2" name="<?= $arResult["WEB_FORM_NAME"] ?>" action="<?=POST_FORM_CAREER_ACTION_URI?>" method="POST" enctype="multipart/form-data">
