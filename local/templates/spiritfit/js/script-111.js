$(document).ready(function() {
    ...
    $(document).on('pjax:complete', function(xhr, status, data, options) {
        ...
        if (xhr.target.id === "js-pjax-container") {
            init();
            yaCounter48440750.hit(options.url);
            gtag('config', 'UA-128203638-1', {'page_title' : document.title,'page_path': options.url});
        }
    ...
    $(document).on("click", ".footer__btn, .header__nav-footer-btn", function(e) {
        gtag("event", "button-click", {"event_category": "Button", "event_action": "button-callback"});
    ...
    $(document).on("change", "select.js-pjax-select", function() {
        if (!$("select.js-pjax-select").parents(".subscription").hasClass("js-page-trial-training"))
    ...
    var reachGo = function(form) {
        ...
        if (go !== null) {
            ym(48440750, 'reachGoal', go);
            gtag("event", "form-sent", {"event_category": "Form", "event_action": go});
        }
    }
    ...
    function reachGoOnline() {
        if ($("form.subscription__aside-form").length) {
            ...
            if (subID == "online") {
                ym(48440750, "reachGoal", "online-abon");
                gtag("event", "form-sent", {"event_category": "Form", "event_action": "online-abon"});
            }
        }
    }
