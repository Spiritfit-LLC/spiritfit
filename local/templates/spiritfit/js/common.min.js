window.onload = function () {
    ...
    if ($(document).ready(function () {
        ...
        }), $(".input--checkbox").styler(), $(".input--tel").inputmask({
        ...
        $('.club__team').slick({
            ...
            clearTimeout(timerBurger), $(this).toggleClass("header__burger--active"), $(this).hasClass("header__burger--active") ? ($(".page-wrapper main, .footer, .header-banner").stop().fadeOut(400), $('.js-slider__stock.slick-slider').slick('slickSetOption', "autoplay", !1, !0), timerBurger = setTimeout(function () {
                ...
                $(".page-wrapper main, .footer, .header-banner").stop().fadeIn(300);
    ...
    $(window).on("mousemove", function (e) {
        ...
        src: 'src',
        itemSelector: '.club__slider-item .club__slider-item-img',
