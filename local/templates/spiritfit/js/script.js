...
$(document).ready(function() {
    ...
    var init = function() {
        ...
        if ($("#map_yandex").length) {
            ymaps.ready(function () {
                var e = parseFloat($("#map_yandex").data("coord-center-lat")),
                    t = parseFloat($("#map_yandex").data("coord-center-lng")),
                    i = parseFloat($("#map_yandex").data("coord-mark-lat")),
                    a = parseFloat($("#map_yandex").data("coord-mark-lng")),
                    zoom = 17,
                    size = (window.innerWidth > 768)? [69, 86] : [35, 43],
                    controls = [];

                if ($("#map_yandex").data("abonement") == "Y"){
                    var str = $("#map_yandex").data("coord-mark-lat");
                    var cord1 = str.split(',');
                    str = $("#map_yandex").data("coord-mark-lng");
                    var cord2 = str.split(',');
                ...
                var n = new ymaps.Map("map_yandex", {
                    center: [e, t],
                    zoom: zoom,
                    controls: controls
                });
...
/* Grid Main PS */
    ...
    $(document).on('click', '#quality_form .btn--white', function(e) {
        ...
        var text68,text69,text70,text71,text72,text73,text74,text75;
        ...
        if(request_err1 == 0 && request_err2 == 0 && request_err3 == 0 && request_err4 == 0 && request_err5 == 0 && request_err6 == 0 && request_err7 == 0 && request_err8 == 0){
