        ...
        <div class="content-center">
            <div class="text-block-wrapper" style="background-image: url(<?=$templateFolder?>/images/block6_back.png);">
                ...
                <div class="text-block">
                    ...
                    <p>
                        Тот, кто первый правильно ответит, получает 100 баллов, второй — 90, третий — 80 и так далее. В любом случае, за каждый правильный ответ участник получает 10 баллов.
                    </p>
                    <p>
