...
<div class="training__aside">
    <div class="training__aside-stage" data-stage="1">
        ...
        <form class="training__aside-form" name="<?= $arResult["WEB_FORM_NAME"] ?>" action="/local/templates/spiritfit-corp/ajax/clubs.php" method="POST" enctype="multipart/form-data">
