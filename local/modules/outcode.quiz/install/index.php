...
class outcode_quiz extends CModule
{
    ...
    function DoInstall()
    {
        ...
        if(!$iblockArr = $iblockObj->GetNext()) {
            ...
            $iBlock['ID'] = $iBlockObj->Add([
                    ...
                    'SORT' => 1,
                    'WORKFLOW' => 'N',
                    'EDIT_FILE_AFTER' => (strpos (SM_VERSION, '12')!==false ? "/local/modules/".$this->MODULE_ID."/admin/iblock_element_edit.php" : "")
                ]
            );
        ...
        $moduleComponentsPath = $DOCUMENT_ROOT . '/local/modules/' . $this->MODULE_ID . '/install/components/';
        ...
        $APPLICATION->IncludeAdminFile(\Bitrix\Main\Localization\Loc::getMessage("QUIZ_MODULE_INSTALL"), $DOCUMENT_ROOT."/local/modules/".$this->MODULE_ID."/install/step.php");
        return true;
    }
    ...
    function DoUninstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(Loc::getMessage("QUIZ_MODULE_UNINSTALL"), $DOCUMENT_ROOT."/local/modules/".$this->MODULE_ID."/install/unstep.php");
        return true;
    }
}