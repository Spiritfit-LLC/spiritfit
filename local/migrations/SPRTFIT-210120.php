        ...
        $this->includeModules();
            ...
            if(empty($prop1)) {
                $res1 = $this->addIblockProperty($id, array(
                    'NAME' => 'Текст кнопки слева внизу на странице клуба',
                    'ACTIVE' => 'Y',
                    'SORT' => 500,
            ...
            if(empty($prop2)) {
                $res2 = $this->addIblockProperty($id, array(
                    'NAME' => 'Ссылка кнопки слева внизу на странице клуба',
                    'ACTIVE' => 'Y',
                    'SORT' => 500,
            ...
            if(empty($prop3)) {
                $res3 = $this->addIblockProperty($id, array(
                    'NAME' => 'Текст кнопки справа внизу на странице клуба',
                    'ACTIVE' => 'Y',
                    'SORT' => 500,
            ...
            if(empty($prop4)) {
                $res4 = $this->addIblockProperty($id, array(
                    'NAME' => 'Ссылка кнопки справа внизу на странице клуба',
                    'ACTIVE' => 'Y',
                    'SORT' => 500,
