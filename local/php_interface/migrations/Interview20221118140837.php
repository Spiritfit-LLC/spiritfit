...
class Interview20221118140837 extends Version
{
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'text',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Варианты ответа(кроме текста):',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ANSWER_VARS',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_QUESTION_NAME' => 'Наименование вопроса (1с)',
    'PROPERTY_QUESTION_TITLE' => 'Текст вопроса',
    'PROPERTY_QUESTION_REQUIRED' => 'Вопрос обязателен?',
    'PROPERTY_QUESTION_TYPE' => 'Тип вопроса',
    'PROPERTY_ANSWER_VARS' => 'Варианты ответа(кроме текста)',
    'PROPERTY_REQUIRED_FROM' => 'Зависит от ответа',
  ),
  'Разделы|edit2' => 
  array (
    'SECTIONS' => 'Разделы',
  ...
  array (
    ...
    'NAME' => 'Название',
    'CODE' => 'Символьный код',
    'PICTURE' => 'Изображение на баннере',
    'DESCRIPTION' => 'Описание на баннере',
    'UF_INTERVIEW_BUTTON' => 'Кнопка',
    'UF_INTERVIEW_BUTTON_LINK' => 'Ссылка',
  ),
  'SEO|edit5' => 
  array (
