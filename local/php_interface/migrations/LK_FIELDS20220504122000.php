...
class LK_FIELDS20220504122000 extends Version
{
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'Y',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Код для 1С (Если нет связи - пусто)',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'CODE_1C',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Обязательно при редактировании',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'REQUIRED',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'Y',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Обязателен при наличии заполненного поля (cим.код поля)',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'REQUIRED_FROM',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'text',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Показывать название поля в шапке',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'SHOW_TITLE_IN_HEAD',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'L',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'Y',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Варианты выбора (Только для radio)',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'RADIO_VALUES',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_FIELD_TITLE' => 'Название поля в ЛК',
    'PROPERTY_FIELD_TYPE' => 'Тип поля',
    'PROPERTY_RADIO_VALUES' => 'Варианты выбора (Только для radio)',
    'PROPERTY_IN_HEAD' => 'В шапке',
    'PROPERTY_SHOW_TITLE_IN_HEAD' => 'Показывать название поля в шапке',
    'PROPERTY_CODE_1C' => 'Код для 1С (Если нет связи - пусто)',
    'PROPERTY_USER_FIELD_CODE' => 'Код поля пользователя',
    'edit1_csection1' => 'Параметры редактирвоания',
    'PROPERTY_CHANGEBLE' => 'Редактируемый',
    'PROPERTY_REQUIRED' => 'Обязательно при редактировании',
    'PROPERTY_REQUIRED_FROM' => 'Обязателен при наличии заполненного поля (cим.код поля)',
    'PROPERTY_VALIDATOR' => 'Валидатор',
  ),
  'Анонс|edit5' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        5 => 'ID',
        6 => 'PROPERTY_CODE_1C',
        7 => 'PROPERTY_USER_FIELD_CODE',
        8 => 'PROPERTY_FIELD_TITLE',
      ),
      'columns_sizes' => 
      array (
        'expand' => 1,
