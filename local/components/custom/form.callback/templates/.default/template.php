...
<div class="popup popup--call" <? if ($_REQUEST["web_form_submit"]): ?>style="display: block;"<? endif; ?>>
    ...
    <div class="popup__window">
        ...
        <div class="popup__form-row">
            <input 
            class="input input--text input--name" 
            ...
            <select class="input input--select" name="form_<?= $arResult["arAnswers"]["club"]['0']["FIELD_TYPE"]?>_<?= $arResult["arAnswers"]["club"]['0']["ID"] ?>" required="required">
