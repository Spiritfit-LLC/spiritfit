                    ...
                    <div class="personal-profile__tab-item profile-quiz-bonus">
                        <div class="share-wrap">
                            ...
                            <ul class="share" style="display: none;">
                                <li>
                                    <a class="share__link share-copy" href="#copy_link" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                ...
                                <li>
                                    <a class="share__link" href="#vk" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                ...
                                <li>
                                    <a class="share__link" href="#fb" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#1C1C1C"></path>
                                ...
                                <li>
                                    <a class="share__link" href="#od" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#1C1C1C"></path>
                                            ...
                                            <defs>
                                                <clippath id="clip0" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                ...
                                <li>
                                    <a class="share__link" href="#tg" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#1C1C1C"></path>
                                ...
                                <li>
                                    <a class="share__link" href="#tw" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#1C1C1C"></path>
                                ...
                                <li>
                                    <a class="share__link" href="#whatsapp" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#1C1C1C"></path>
                                ...
                                <li>
                                    <a class="share__link" href="#viber" data-url="<?=$arResult['LINK_GET_BONUS']?>" data-title="Пригласи друга и получи 10 баллов в КВИЗ" data-description="">
                                        <svg width="18" height="18" viewbox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18Z" fill="#1C1C1C"></path>
