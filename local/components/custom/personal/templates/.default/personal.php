        ...
        <div style="position:relative;margin-top: 50px;">
            <div class="personal-profile__tabs">
                ...
                <? if( defined('IS_QUIZ_ACTIVE') && IS_QUIZ_ACTIVE && !empty($arParams['LINK_GET_BONUS'])) {
                    ?>
                    <div class="profile-quiz-btn is-hide-mobile"  data-link="<?=QUIZ_LINK?>">
                        <?=QUIZ_LINK_TITLE?>
                    </div>
                    <div class="profile-quiz-bonus is-hide-mobile">
        ...
        <? if( defined('IS_QUIZ_ACTIVE') && IS_QUIZ_ACTIVE && !empty($arParams['LINK_GET_BONUS'])) {
            ?>
                <style>
                    ...
                    .quiz-btn .profile-quiz-btn{
                        margin-right: 0;
                    }
                    .quiz-btn .open-share-block{
                        padding-right: 0;
                    }
                </style>
            <div class="quiz-btn">
                <div class="profile-quiz-btn is-hide-desktop"  data-link="<?=QUIZ_LINK?>">
                    <?=QUIZ_LINK_TITLE?>
                </div>
                <div class="profile-quiz-bonus is-hide-desktop">
                    <div class="share-wrap">
                        <a class="open-share-block" href="#open">
                            <span>Пригласи друга и получи 10 баллов в КВИЗ</span>
                        </a>
