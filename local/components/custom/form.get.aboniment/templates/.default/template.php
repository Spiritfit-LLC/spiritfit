				...
				<? if( isset($arResult["ELEMENT"]["BASE_PRICE"]["PRICE"]) || (!empty($arResult["ELEMENT"]["PRICES"][0]["SIGN"]) && $arResult["ELEMENT"]["PRICES"][0]["SIGN"] == "Бесплатно") ) { ?>
					...
					<div class="subscription__bottom">
						<div class="subscription__total">
							...
							<input type="hidden" name="OLD_PRICE" value="<?=( !empty($arResult["CLUB_ID"]) && !empty($arResult["ELEMENT"]["PRICES"][0]["PRICE"]) ) ? $arResult["ELEMENT"]["PRICES"][0]["PRICE"] : $arResult["ELEMENT"]["PROPERTIES"]["BASE_PRICE"]["VALUE"][0]["PRICE"]?>">
