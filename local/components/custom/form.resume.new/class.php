...
class FormResumeNew extends CBitrixComponent implements Controllerable {
    ...
    public function sendAction(){
        ...
        $api=new Api([
            ...
            "params"=>[
                "subject"=>$subject,
                "message"=>"Привет! Мы получили твой отклик и  зарегистрировали для рассмотрения на представленную вакансию. В случае положительного решения – жди приглашение на телефонное интервью.  Рекомендуем посмотреть все наши актуальные вакансии на сайте hh.ru.  Приходи на бесплатную персональную тренировку в любой клуб нашей сети и убедись, что Spirit. #естьвкаждом.",
