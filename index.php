...
if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true') {
	...
	$APPLICATION->SetPageProperty("description", "Spirit. Fitness - современный, доступный фитнес-клуб рядом с вами. Для тех, кто ценит качество, нацелен на результат и не привык переплачивать. Выгодные тарифы с ежемесячной оплатой, бесплатная пробная тренировка. Запишись прямо сейчас!");
