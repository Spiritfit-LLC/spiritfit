...
$APPLICATION->SetPageProperty("title", "Степ-аэробика в Spirit. Fitness");
...
?>
        ...
        <div class="page-hiden-slider__header">
            <div class="page-desc-short">
                <div class="page-desc-short__text">
                    <?=htmlspecialcharsback($settings["PROPERTIES"]["STEP_AEROBIKA_SHORT_DESC"]["VALUE"]["TEXT"])?>
                </div>
            ...
            <div class="page-desc-banner <?if (defined('H1_BIG_COLORFUL')) echo "big-colorful"?>">
                <div class="owl-carousel">
                    <?foreach ($settings["PROPERTIES"]["STEP_AEROBIKA_BANNER_IMGS"]["VALUE"] as $IMG):?>
    ...
    <section class="cycle-description page-white-description" style="margin-top: 80px;">
        <div class="content-center">
            <?for ($i=0; $i<count($settings["PROPERTIES"]["STEP_AEROBIKA_DESC"]["VALUE"]); $i++):?>
                <div class="ft-desc__block desc__block">
                    <?if (!empty($settings["PROPERTIES"]["STEP_AEROBIKA_DESC"]["DESCRIPTION"][$i])):?>
                        <div class="b-cards-slider__heading">
                            <div class="b-cards-slider__title">
                                <h2><?=$settings["PROPERTIES"]["STEP_AEROBIKA_DESC"]["DESCRIPTION"][$i]?></h2>
                            </div>
                        </div>
                    <?endif;?>
                    <div class="ft-desc__text">
                        <?=htmlspecialcharsback($settings["PROPERTIES"]["STEP_AEROBIKA_DESC"]["VALUE"][$i]["TEXT"])?>
                    </div>
                </div>
            <?endfor;?>
        </div>
    ...
    <section id="form-request" style="margin-top: 80px;">
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "WEB_FORM_ID" => Utils::GetFormIDBySID($settings["PROPERTIES"]["STEP_AEROBIKA_FORM_SID"]["VALUE"]),
                ...
                "FORM_TYPE" =>$settings["PROPERTIES"]["STEP_AEROBIKA_FORM_TYPE"]["VALUE"],
                "TEXT_FORM" => $settings["PROPERTIES"]["STEP_AEROBIKA_FORM_TITLE"]["VALUE"]
            ),
            false);
        ?>
    </section>
