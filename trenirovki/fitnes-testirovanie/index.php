...
$includeParams=[
    "HEAD_DESC"=>$objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_SHORT_DESC"]["VALUE"]["TEXT"],
    "BUTTON"=>$objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_BUTTON"]["VALUE"],
    "BUTTON_LINK"=>$objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_BUTTON"]["DESCRIPTION"],
    "HEAD_IMAGES"=>$objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_IMAGES"]["VALUE"],
];
...
<section class="page-white-description">
    <div class="content-center">
        <div class="desc__block">
            <?for ($i=0; $i<count($objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_PAGE_DESC"]["VALUE"]); $i++):?>
                <?if (!empty($objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_PAGE_DESC"]["DESCRIPTION"][$i])):?>
                    <div class="b-cards-slider__heading">
                        <div class="b-cards-slider__title">
                            <h2><?=$objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_PAGE_DESC"]["DESCRIPTION"][$i]?></h2>
                        </div>
                    </div>
                <?endif;?>
                <div class="desc__block__text">
                    <?=htmlspecialcharsback($objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_PAGE_DESC"]["VALUE"][$i]["TEXT"])?>
                </div>
            <?endfor;?>
        </div>
    </div>
</section>
<?if (!empty($objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_FORM_TYPE"]["VALUE"])):?>
...
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "WEB_FORM_ID" => Utils::GetFormIDBySID($objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_FORM_SID"]["VALUE"]),
        ...
        "FORM_TYPE" =>$objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_FORM_TYPE"]["VALUE"],
        "TEXT_FORM" => $objects[$ELEMENT_ID]["PROPERTIES"]["FITTEST_FORM_TITLE"]["VALUE"]
    ),
    false);
?>
</section>
