...
if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true') {
	...
	echo "<title>Продукты</title>";
	$APPLICATION->SetTitle("Продукты");
	$APPLICATION->SetPageProperty("description", "Spirit. Fitness представляет линейку продуктов для тренировок и контроля результатов членов клуба.");
	$APPLICATION->SetPageProperty("title", "Продукты - инструменты для тренировок и контроля результатов членов клуба Spirit Fitness");
...
<? else: ?>
	...
	Array(
		...
		"PROPERTY_CODE" => array("NUMBER","SHOW_ON_MAIN",""),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
