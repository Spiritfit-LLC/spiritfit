<?
	...
	//https://www.figma.com/file/VXTpPsVQNrty07rNZGlpzo/Spirit?node-id=208%3A404
?>
<div class="content-center">
	...
	<div class="loyality-levels">
		...
		<div class="loyality-levels-item">
			...
			<div class="loyality-levels-item__content">
				<div class="loyality-levels-item__description"><a href="#">Регистрация</a></div>
				<div class="loyality-levels-item__button">
					<div class="description"><a href="#">Забыли пароль</a></div>
					<div class="button-wrapper"><a class="btn" href="#">Войти</a></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="loyality-warning">
		...
		<div class="loyality-warning-description">Чтобы использовать бонусы необходимо <a href="#">войти</a></div>
		<div class="loyality-warning-description">Ознакомиться с <a href="#">Положением</a> «О Программе лояльности»</div>
	</div>
	<div class="loyality-bonus">
		...
		<div class="loyality-bonus-table">
			...
			<div class="table-cell">
				...
				<ul>
					<li>
						<span class="title">Дневное время x <span>1,2</span></span>
						Посещайте клубы в период с 10.00 до 17.00 и мы умножим ваши бонусы за посещения x 1,2.
					</li>
					<li>
						<span class="title">Активные посещения x <span>1,2</span></span>
