...
<div class="content-center">
	<div class="loyality-top">
		...
		<div class="loyality-top-description">
            ...
            Для участия в программе необходимо оплатить любой вид контракта, зарегистрироваться в личном кабинете пользователя на сайте, войти в меню "Программа лояльности" и нажать кнопку "РЕГИСТРАЦИЯ В ПРОГРАММЕ".
		</div>
			...
			<div class="table-cell">
				...
				<ul>
					...
					<li>
                        ...
                        Укажите вашу дату рождения при оформлении контракта и получите +100 бонусов в день рождения.
					</li>
					<li>
