...
<!--    <div class="content-center">-->
<!--        <div class="b-section__title">-->
<!--            <h2>Накопление и списание бонусов</h2>-->
<!--        </div>-->
<!--    </div>-->
<!--    --><?//
//    $faq=CIBlockElement::GetList(
//        array("SORT"=>"ASC"),
//        array("IBLOCK_ID"=>Utils::GetIBlockIDBySID("loyalty-faq"), "ACTIVE"=>"Y"),
//        false,
//        false);
//    ?>
<!--    <div class="content-center">-->
<!--        <div class="loyalty-actions__header">-->
<!--            <div class="loyalty-actions__desc">-->
<!--                Чем чаще и дольше вы тренируетесь — тем выше уровень лояльности и больше привилегий.-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="loyalty-faq__body">-->
<!--            --><?//while($LOYALTY_FAQ=$faq->Fetch()):?>
<!--                <div class="b-accordion__item" onclick="open_accrodion(this)">-->
<!--                    <div class="b-accordion__heading">-->
<!--                        <span>--><?//=$LOYALTY_FAQ['NAME']?><!--</span>-->
<!--                    </div>-->
<!--                    <div class="b-accordion__content">-->
<!--                        <div itemprop="text">--><?//=$LOYALTY_FAQ['PREVIEW_TEXT']?><!--</div>-->
<!--                    </div>-->
<!--                </div>-->
<!--            --><?//endwhile;?>
<!--        </div>-->
