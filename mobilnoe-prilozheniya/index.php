...
if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true') {
	...
	$APPLICATION->SetPageProperty("description", "У нас есть мобильное приложение 📲 с разными программами тренировок, вы сможете подобрать для себя комплекс упраждений и заниматься дома или на улице.");
}
?>
