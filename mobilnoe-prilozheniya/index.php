...
if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true') {
	...
	$APPLICATION->SetPageProperty("title", "Мобильное приложение - Spirit. Fitness - сеть фитнес-клубов в Москве и Московской области");
	$APPLICATION->SetPageProperty("description", "Мобильное приложение от Spirit. Fitness — это простой и удобный инструмент в вашем телефоне. В приложении можно купить абонемент в любой фитнес-клуб сети, приобрести дополнительные услуги и онлайн-тренировки, видеть расписание занятий, свое персональное расписание, получить инструкцию по построению и контролю тренировочного процесса.");
}
?>
